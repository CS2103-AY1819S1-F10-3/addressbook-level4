...
public class ListCommandSystemTest extends AddressBookSystemTest {
     ...
     * box displays {@code Messages#MESSAGE_CLIENTS_LISTED_OVERVIEW} with the number of people in the filtered list,
    ...
    private void assertCommandSuccess(String command, Model expectedModel) {
        String expectedResultMessage = String.format(
                MESSAGE_CLIENTS_LISTED_OVERVIEW, expectedModel.getFilteredContactList().size());
