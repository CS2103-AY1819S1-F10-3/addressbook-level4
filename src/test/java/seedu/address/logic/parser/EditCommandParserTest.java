...
public class EditCommandParserTest {
    ...
    private EditCommandParser parser = new EditClientCommandParser();
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor, EditCommandParser.ContactType.CLIENT);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditCommand(targetIndex, descriptor, EditCommandParser.ContactType.CLIENT);
        assertParseSuccess(parser, userInput, expectedCommand);
