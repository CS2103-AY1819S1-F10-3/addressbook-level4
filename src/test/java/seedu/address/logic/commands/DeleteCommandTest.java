...
public class DeleteCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        DeleteCommand deleteCommand = new DeleteCommand(INDEX_FIRST_PERSON, Command.ContactType.CLIENT);
    ...
    public void execute_invalidIndexUnfilteredList_throwsCommandException() {
        ...
        DeleteCommand deleteCommand = new DeleteCommand(outOfBoundIndex, Command.ContactType.CLIENT);
    ...
    @Test
    public void equals() {
        DeleteCommand deleteFirstCommand = new DeleteCommand(INDEX_FIRST_PERSON, Command.ContactType.CLIENT);
        DeleteCommand deleteSecondCommand = new DeleteCommand(INDEX_SECOND_PERSON, Command.ContactType.CLIENT);

        // same object -> returns true
        assertTrue(deleteFirstCommand.equals(deleteFirstCommand));

        // same values -> returns true
        DeleteCommand deleteFirstCommandCopy = new DeleteCommand(INDEX_FIRST_PERSON, Command.ContactType.CLIENT);
